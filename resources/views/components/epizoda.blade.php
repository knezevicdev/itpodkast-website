<div class="p-6 border-2 border-black min-h-full">
    <div class="grid grid-cols-1 gap-3">
        ...
        <div class="flex flex-col">
            ...
            <a href="{{ route('epizoda', [ 'slug' => $slug ]) }}">
            ...
            <div class="mt-auto flex justify-between flex-col">
                <div class="mt-4">
                    <a href="{{ route('epizoda', [ 'slug' => $slug ]) }}"
                       class="px-6 py-2 bg-black text-white font-azeret-mono font-semibold text-md inline-block transition-shadow hover:shadow-effect-orange">Pusti
                        epizodu</a>
                </div>
